; config to be used by exe/display-api.
; for generated binding names
...
(define-as generated list-q
  ...
  (declare db-ids-t (type (struct (link (struct db-ids-struct*)) (data db-id-t)))
    ...
    (db-graph-records-add a value) (db-graph-records-t* db-graph-records-t* db-graph-record-t)
    ...
    (db-graph-records-drop a) (db-graph-records-t* db-graph-records-t*)
    (db-data-list-length a) (size-t db-data-list-t*)
    (db-data-records-length a) (size-t db-data-records-t*)
    (db-ids-length a) (size-t db-ids-t*) (db-graph-records-length a) (size-t db-graph-records-t*)))
