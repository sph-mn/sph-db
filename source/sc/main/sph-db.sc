...
(declare
  ...
  (status-t db-txn-t db-record-values-t db-id-t*) (db-record-get txn ids match-all result-records)
  (status-t db-txn-t db-ids-t boolean db-records-t*) (db-record-delete txn ids)
