...
(pre-define
  ...
  (db-record-is-virtual env record-id) (db-type-is-virtual (db-type-get-by-id env (db-id-type record-id)))
...
(declare
  ...
  (db-relation-read selection count result) (status-t db-relation-selection-t* db-count-t db-relations-t*)
  ...
  (db-record-read selection count result-records) (status-t db-record-selection-t db-count-t db-records-t*)
  ...
  (db-record-virtual-from-any type-id data data-size) (db-id-t db-type-id-t void* uint8-t)
