...
int db_mdb_compare_id(const MDB_val* a, const MDB_val* b) { return ((db_id_compare((db_pointer_to_id((a->mv_data))), (db_pointer_to_id((b->mv_data)))))); }
int db_mdb_compare_relation_key(const MDB_val* a, const MDB_val* b) {
...
int db_mdb_compare_relation_data(const MDB_val* a, const MDB_val* b) {
