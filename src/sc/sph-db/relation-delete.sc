...
(pre-define db-relation-internal-delete-0010
  (begin
    ...
    (label set-key-0010
      (set id-label (sph-array-current-get label) val-id.mv-data &id-label)
      ...
      (label each-key-0010
        ...
        (if (sph-array-current-in-range label) (goto set-key-0010) (goto exit))))
  ...
  (begin
    ...
    (label set-key-0110
      (set
        ...
        id-label (sph-array-current-get label)
        (array-get relation-key 0) id-right
        (array-get relation-key 1) id-label
        val-relation-key.mv-data relation-key)
      ...
      (label each-key-0110
        ...
        (if (sph-array-current-in-range right) (goto set-key-0110)
          (begin
            (sph-array-current-forward label)
            (if (sph-array-current-in-range label) (begin (sph-array-current-rewind right) (goto set-key-0110))
              (goto exit))))))
  ...
  (begin
    ...
    (label set-range-0100
      ...
      (if db-mdb-status-is-success
        ...
        db-mdb-status-expect-notfound)
      (sph-array-current-forward right)
      (if (sph-array-current-in-range right) (goto set-range-0100) (goto exit)))
    ...
    (label set-range-1000
      ...
      (label each-key-1000
        (if db-mdb-status-is-success
          ...
          db-mdb-status-expect-notfound)
        (sph-array-current-forward left)
        (if (sph-array-current-in-range left) (goto set-range-1000) (goto exit))))
    ...
    (label set-key-1011-1111
      ...
      (if db-mdb-status-is-success (goto each-data-1011-1111)
        (label each-key-1011-1111
          (sph-array-current-forward left)
          (if (sph-array-current-in-range left) (goto set-key-1011-1111)
            (begin
              (sph-array-current-forward label)
              (if (sph-array-current-in-range label)
                (begin
                  (set id-label (sph-array-current-get label))
...
(define
  ...
  (label exit db-mdb-status-success-if-notfound status-return))
